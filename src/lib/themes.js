...
export const BUILT_IN_THEMES = {
  sepia: {
    ...
    text: '#3b2f20', textMuted: '#574837', textDim: '#7a6652',
  ...
  dark: {
    ...
    text: '#e6edf3', textMuted: '#bdc5cd', textDim: '#8b949e',
  ...
  light: {
    ...
    text: '#1f2328', textMuted: '#3e444b', textDim: '#636c76',
  ...
  cherry: {
    ...
    text: '#f2dde1', textMuted: '#ccabb1', textDim: '#9e6d76',
  ...
  sunset: {
    ...
    text: '#f5e6c8', textMuted: '#cfb58b', textDim: '#a07840',
  ...
  moss: {
    ...
    text: '#1e2c14', textMuted: '#344728', textDim: '#4e6840',
